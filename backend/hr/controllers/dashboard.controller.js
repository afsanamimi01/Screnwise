...
/**
 * HR dashboard: everything is computed here, in the same order the frontend
 * shows it - KPI cards, then the job list, then the applicant-source chart -
 * so the page itself only has to render what it's given.
 */
export async function getDashboard(req, res, next) {
  try {
    ...
    // ---- Step 1: this company's jobs (screening batches never show here) ----
