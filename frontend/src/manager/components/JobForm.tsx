...
export function JobForm({
  ...
  return (
    <div className="manager-job-form">
      <div className="manager-job-form__col">
        <section className="manager-job-form__card">
          <div className="manager-job-form__card-head">
            <h2 className="manager-job-form__card-title">Role details</h2>
          </div>
          <div className="manager-job-form__grid">
            <div className="manager-job-form__field manager-job-form__field--wide">
              <label className="manager-job-form__label" htmlFor="title">
                Job title
              </label>
              <input
                id="title"
                className="manager-job-form__input"
                value={job.title}
                onChange={(e) => set("title", e.target.value)}
                placeholder="Senior backend engineer"
              />
            </div>
            <div className="manager-job-form__field">
              <label className="manager-job-form__label" htmlFor="department">
                Department
              </label>
              <input
                id="department"
            ...
            <div className="manager-job-form__field">
              <label className="manager-job-form__label" htmlFor="location">
                Location
              </label>
              <input
                id="location"
            ...
            <div className="manager-job-form__field">
              <label className="manager-job-form__label" htmlFor="type">
                Employment type
              </label>
              <select
                id="type"
            ...
            <div className="manager-job-form__field">
              <label className="manager-job-form__label" htmlFor="education">
            ...
            <div className="manager-job-form__field manager-job-form__field--wide">
              <label className="manager-job-form__label" htmlFor="description">
                Description
              </label>
              <textarea
                id="description"
                className="manager-job-form__textarea"
        ...
        <section className="manager-job-form__card">
          <div className="manager-job-form__card-head">
            <h2 className="manager-job-form__card-title">Skills and requirements</h2>
          ...
          <div className="manager-job-form__grid">
            <div className="manager-job-form__field">
              <span className="manager-job-form__label">Required skills</span>
              <TagInput
            ...
            <div className="manager-job-form__field">
              <span className="manager-job-form__label">Nice-to-have skills</span>
              <TagInput
            ...
            <div className="manager-job-form__field">
              <label className="manager-job-form__label" htmlFor="minYears">
              ...
              <input
                ...
                type="number"
                min={0}
                className="manager-job-form__input manager-job-form__input--num"
                value={job.minYears}
                onChange={(e) => set("minYears", Number(e.target.value))}
              />
            </div>
            <div className="manager-job-form__field">
              <span className="manager-job-form__label">Certifications</span>
              <TagInput
        ...
        <section className="manager-job-form__card manager-job-form__card--gate">
          ...
          <div className="manager-job-form__gate-body">
            <label className="manager-job-form__check">
              <input
                type="checkbox"
            ...
            <div className="manager-job-form__field manager-job-form__field--narrow">
              <label className="manager-job-form__label" htmlFor="gateYears">
            ...
            <div className="manager-job-form__field">
              <span className="manager-job-form__label">Must-have skills</span>
              <TagInput
      ...
      <div className="manager-job-form__col">
        <section className="manager-job-form__card">
          <div className="manager-job-form__card-head">
            <h2 className="manager-job-form__card-title">Scoring weights</h2>
            <p className="manager-job-form__card-desc">
              How much each dimension counts when ranking the candidates who pass the hard filters.
            </p>
          </div>
          <div className="manager-job-form__weights">
            {(Object.keys(weightLabels) as (keyof ScoringWeights)[]).map((key) => (
              <div key={key} className="manager-job-form__weight">
                <div className="manager-job-form__weight-head">
                  <span className="manager-job-form__label">{weightLabels[key]}</span>
                  <span className="manager-job-form__weight-value">{job.weights[key]}%</span>
                </div>
                <input
                  type="range"
                  className="manager-job-form__range"
            ...
            <div
              className={
                "manager-job-form__total" +
                (weightTotal === 100
                  ? " manager-job-form__total--ok"
        ...
        {isScreening ? null : (
          <section className="manager-job-form__card">
            <div className="manager-job-form__card-head">
              <h2 className="manager-job-form__card-title">Public application page</h2>
            </div>
            <div className="manager-job-form__public">
              <div className="manager-job-form__switch-row">
                ...
                <button
                  ...
                  className={
                    "manager-job-form__switch" +
                    (job.publicApplyEnabled ? " manager-job-form__switch--on" : "")
                  }
                  onClick={() => set("publicApplyEnabled", !job.publicApplyEnabled)}
                >
                  <span className="manager-job-form__switch-knob" />
                </button>
              </div>
        ...
        <div className="manager-job-form__actions">
          ...
          <button
            type="button"
            className="manager-job-form__btn manager-job-form__btn--ghost"
