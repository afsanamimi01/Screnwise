...
/** Sidebar links for the recruiter workspace. Reorder / add / remove here. */
const NAV_ITEMS: NavItem[] = [
  { to: "/dashboard", label: "Dashboard", icon: LayoutDashboard },
  { to: "/jobs", label: "Jobs", icon: ClipboardList },
];

/** Extra links shown only when an admin is viewing a recruiter page. */
...
export function HrShell({
  ...
  const items = user.role === "admin" ? [...NAV_ITEMS, ...ADMIN_EXTRA] : NAV_ITEMS;
